...
import type { LoginAccessTokenData, LoginAccessTokenResponse, LoginAccessTokenError, GetUsersData, GetUsersResponse, CreateUserData, CreateUserResponse, CreateUserError, GetUserMeData, GetUserMeResponse, PatchUserMeData, PatchUserMeResponse, PatchUserMeError, GetTeamsData, GetTeamsResponse, GetTeamsError, CreateTeamData, CreateTeamResponse, CreateTeamError, DeleteTeamData, DeleteTeamResponse, DeleteTeamError, GetTeamData, GetTeamResponse, GetTeamError, ListJobsData, ListJobsResponse, ListJobsError, CreateJobData, CreateJobResponse, CreateJobError, DeleteJobData, DeleteJobResponse, DeleteJobError, RunTaskData, RunTaskResponse, RunTaskError, UpdateJobData, UpdateJobResponse, UpdateJobError, ListJobTasksData, ListJobTasksResponse, ListJobTasksError, DeleteTaskResultData, DeleteTaskResultResponse, DeleteTaskResultError, GetTaskResultData, GetTaskResultResponse, GetTaskResultError, ListTeamMembersData, ListTeamMembersResponse, ListTeamMembersError, CreateTeamMemberData, CreateTeamMemberResponse, CreateTeamMemberError, RemoveTeamMemberData, RemoveTeamMemberResponse, RemoveTeamMemberError, UpdateTeamMemberData, UpdateTeamMemberResponse, UpdateTeamMemberError, ListLanguagesData, ListLanguagesResponse, CreateLanguageData, CreateLanguageResponse, CreateLanguageError, ListWorkerData, ListWorkerResponse, ListWorkerError } from './types.gen';
 ...
 * 更新当前用户信息
 */
export const patchUserMe = <ThrowOnError extends boolean = false>(options: Options<PatchUserMeData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).patch<PatchUserMeResponse, PatchUserMeError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 * 添加空间成员（可指定是否为管理员）
 */
export const createTeamMember = <ThrowOnError extends boolean = false>(options: Options<CreateTeamMemberData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<CreateTeamMemberResponse, CreateTeamMemberError, ThrowOnError>({
        url: '/api/v1/team/{team_id}/members',
        ...options,
        headers: {
            'Content-Type': 'application/json',
