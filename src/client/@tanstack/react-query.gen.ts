...
import { type Options, loginAccessToken, getUsers, createUser, getUserMe, patchUserMe, getTeams, createTeam, deleteTeam, getTeam, listJobs, createJob, deleteJob, runTask, updateJob, listJobTasks, deleteTaskResult, getTaskResult, listTeamMembers, createTeamMember, removeTeamMember, updateTeamMember, listLanguages, createLanguage, listWorker } from '../sdk.gen';
import { queryOptions, type UseMutationOptions, infiniteQueryOptions, type InfiniteData } from '@tanstack/react-query';
import type { LoginAccessTokenData, LoginAccessTokenError, LoginAccessTokenResponse, GetUsersData, CreateUserData, CreateUserError, CreateUserResponse, GetUserMeData, PatchUserMeData, PatchUserMeError, PatchUserMeResponse, GetTeamsData, GetTeamsError, GetTeamsResponse, CreateTeamData, CreateTeamError, CreateTeamResponse, DeleteTeamData, DeleteTeamError, DeleteTeamResponse, GetTeamData, ListJobsData, ListJobsError, ListJobsResponse, CreateJobData, CreateJobError, CreateJobResponse, DeleteJobData, DeleteJobError, DeleteJobResponse, RunTaskData, RunTaskError, RunTaskResponse, UpdateJobData, UpdateJobError, UpdateJobResponse, ListJobTasksData, ListJobTasksError, ListJobTasksResponse, DeleteTaskResultData, DeleteTaskResultError, DeleteTaskResultResponse, GetTaskResultData, ListTeamMembersData, ListTeamMembersError, ListTeamMembersResponse, CreateTeamMemberData, CreateTeamMemberError, CreateTeamMemberResponse, RemoveTeamMemberData, RemoveTeamMemberError, RemoveTeamMemberResponse, UpdateTeamMemberData, UpdateTeamMemberError, UpdateTeamMemberResponse, ListLanguagesData, CreateLanguageData, CreateLanguageError, CreateLanguageResponse, ListWorkerData, ListWorkerError, ListWorkerResponse } from '../types.gen';
...
export const patchUserMeMutation = (options?: Partial<Options<PatchUserMeData>>) => {
    const mutationOptions: UseMutationOptions<PatchUserMeResponse, AxiosError<PatchUserMeError>, Options<PatchUserMeData>> = {
        mutationFn: async (localOptions) => {
...
export const listJobsInfiniteOptions = (options: Options<ListJobsData>) => {
    return infiniteQueryOptions<ListJobsResponse, AxiosError<ListJobsError>, InfiniteData<ListJobsResponse>, QueryKey<Options<ListJobsData>>, number | Pick<QueryKey<Options<ListJobsData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
    // @ts-ignore
    {
        queryFn: async ({ pageParam, queryKey, signal }) => {
            // @ts-ignore
...
export const createJobQueryKey = (options: Options<CreateJobData>) => createQueryKey('createJob', options);
...
export const createJobMutation = (options?: Partial<Options<CreateJobData>>) => {
    const mutationOptions: UseMutationOptions<CreateJobResponse, AxiosError<CreateJobError>, Options<CreateJobData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await createJob({
                ...options,
                ...localOptions,
...
export const deleteJobMutation = (options?: Partial<Options<DeleteJobData>>) => {
    const mutationOptions: UseMutationOptions<DeleteJobResponse, AxiosError<DeleteJobError>, Options<DeleteJobData>> = {
        mutationFn: async (localOptions) => {
...
export const updateJobMutation = (options?: Partial<Options<UpdateJobData>>) => {
    const mutationOptions: UseMutationOptions<UpdateJobResponse, AxiosError<UpdateJobError>, Options<UpdateJobData>> = {
        mutationFn: async (localOptions) => {
...
export const createTeamMemberQueryKey = (options: Options<CreateTeamMemberData>) => createQueryKey('createTeamMember', options);

export const createTeamMemberOptions = (options: Options<CreateTeamMemberData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
        ...
        queryKey: createTeamMemberQueryKey(options)
    });
};

export const createTeamMemberMutation = (options?: Partial<Options<CreateTeamMemberData>>) => {
    const mutationOptions: UseMutationOptions<CreateTeamMemberResponse, AxiosError<CreateTeamMemberError>, Options<CreateTeamMemberData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await createTeamMember({
                ...options,
                ...localOptions,
