...
export const getLanguagesOptions = (options?: Options<GetLanguagesData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
